      ...
      <View className="w-full justify-start items-center px-4 pb-4 flex-1">
        ...
        <View className="bg-[#EEE9E9] w-full rounded-3xl py-10 px-6 pb-10 space-y-6">
          ...
          <View className="space-y-2 w-full flex-col justify-center">
            ...
            <View className="flex-row space-x-4 items-center border border-[#51259B] rounded-full w-full h-[60px] bg-[#FFFAFA] px-5">
          ...
          <TouchableOpacity onPress={() => router.push("/(main)")} className="rounded-full bg-[#51259B] w-full h-[60px] items-center justify-center">
