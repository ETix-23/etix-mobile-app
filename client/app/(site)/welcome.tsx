    ...
    <SafeAreaView className="bg-white flex-1">
      ...
      <View className="flex-1 items-center flex-col justify-between pb-3">
        ...
        <View className="flex-row w-full space-x-3 px-2">
          <TouchableOpacity onPress={() => router.push("/auth/login")} className="text-sm bg-[#51259B] flex-1 justify-center h-[60px] rounded-full">
            <Text className="text-white text-center uppercase">Login</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => router.push("/auth/register")} className="text-sm bg-[#51259B] flex-1 justify-center h-[60px] rounded-full">
